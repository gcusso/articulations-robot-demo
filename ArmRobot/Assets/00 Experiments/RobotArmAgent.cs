...
public class RobotArmAgent : Agent
{
    ...
    private PositionRandomizer tablePositionRandomizer;

    void Start()
    {
        robotController = robot.GetComponent<RobotController>();
        touchDetector = cube.GetComponent<TouchDetector>();
        tablePositionRandomizer = cube.GetComponent<PositionRandomizer>();
    }
    ...
    public override void OnEpisodeBegin()
    {
        ...
        tablePositionRandomizer.MoveToRandomPosition();
    }
